...
dat<-read.table("sample_data/mismatches_for_SVM_training.txt")
...
# 3. Train SVM
svm_model.TRAIN.As<-train_svm_return_model(dat.TRAIN.As, c("missmatch_freq.rep1","TGratio.rep1","missmatch_freq.rep2","TGratio.rep2","react.B1","react.B2")) # 73.69668

# 4. Test SVM
dat.withPred<-run_svm_return_dataset_withPred(dat.TRAIN.As, svm_model.TRAIN.As,c("missmatch_freq.rep1","TGratio.rep1","missmatch_freq.rep2","TGratio.rep2","react.B1","react.B2")) # 73.69668


tgirt_with_vitro_react.ROC
